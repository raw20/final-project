    ...
    <div className={footerDisplay === "off" ? "ft-wrapper off" : "ft-wrapper"}>
      <div className="ft-inner">
        <div className="company">
          <img className="companyLogo" alt="companyLogo" src="img/logo2.png" />
        </div>
        <div className="info">
          <h2>(주)엑스퍼트 컨설팅</h2>
